...
# This script contains command line tests for snpfinder
# This script uses the same skeleton provided in the mypileup repo
...
runcmd_pass "snpfinder ${EXDATADIR}/test.mpileup"

runcmd_fail "snpfinder ${EXDATADIR}/testXYZ.mpileup"